...
public class GitHubHookServiceImplTest {
    private String hookMessage = "{\n"
            ...
            + "  \"forced\": false,\n"
            + "  \"base_ref\": null,\n"
            + "  \"compareVersion\": \"https://github.com/z521598/pipeline_v2/compareVersion/f6471514996d...9f2bae75366c\",\n"
            + "  \"commits\": [\n"
            + "    {\n"
            ...
            + "    \"compare_url\": \"https://api.github.com/repos/z521598/pipeline_v2/compareVersion/{base}...{head}\",\n"
